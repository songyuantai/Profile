...
namespace Profile
{
    ...
    internal sealed class RestoreCommand
    {
        ...
        private RestoreCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        {
            // Switch to the main thread - the call to AddCommand in RestoreCommand's constructor requires
            // the UI thread.
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            var f = new RestoreForm(solutionName);
            f.Show();
        }
    }
}
